...
TEST(OpenSslUniformPseudorandomGenerator,
  ...
  int kNumRandomBytes = 16;
  ASSERT_OK_AND_ASSIGN(std::vector<unsigned char> seq1,
                       prng->GetPseudorandomBytes(kNumRandomBytes));
  ASSERT_OK_AND_ASSIGN(std::vector<unsigned char> seq2,
                       prng->GetPseudorandomBytes(kNumRandomBytes));
  ...
  ASSERT_EQ(seq1.size(), kNumRandomBytes);
  ASSERT_EQ(seq2.size(), kNumRandomBytes);
  ASSERT_EQ(seq3.size(), kNumRandomBytes);
  ASSERT_EQ(seq4.size(), kNumRandomBytes);

  ASSERT_EQ(seq1, output_block_1);
  ASSERT_EQ(seq2, output_block_2);
  ASSERT_EQ(seq3, output_block_3);
  ASSERT_EQ(seq4, output_block_4);
}
